...
- will I be prevented from submitting correctly if I fill out all required fields, then clear one?
- after completely submitting a form, change one of the fields to make it invalid - does the "You Submitted" modal disappear correctly?
- after completely submitting a form, change one of the fields (do not make the field invalid, though) - the "You Submitted" modal updates to reflect your input change
- enter 100+ characters in the message field and completely submit your form - your input should go off the side of the "You Submitted" modal
- enter only spaces in the name fields - you should still be able to submit your form 
...
* [X] the component renders ONE error message if the user enters less than 5 characters into the firstname field. Make sure to use async / await and the correct screen method to account for state change.
